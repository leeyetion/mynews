...
public class HomeActivity extends BaseActivity {
    ...
    private void InitData() {
        ...
        //给ViewPager设置适配器
        vp_fragement.setAdapter(new MyFragmentPagerAdapter(getSupportFragmentManager(), f_list));
        vp_fragement.setCurrentItem(0);//设置当前显示标签页为第一页


        //tabStrip = (PagerSlidingTabStrip) findViewById(R.id.tabs);
        // 字体大小
        tabs.setTextSize(DensityUtils.dpi2px(this, 18));
        // 未选中状态下的字体颜色
        ...
        // 滚动线的高度
        tabs.setIndicatorHeight(DensityUtils.dpi2px(this, (int) 5.0f));
        tabs.setIndicatorColor(Color.parseColor("#00AB94"));
        // 滚动线背景的高度
        tabs.setUnderlineHeight(DensityUtils.dpi2px(this, (int) 1.0f));
        tabs.setUnderlineColor(Color.parseColor("#EEEDEB"));

        // 标签分割线颜色
        tabs.setDividerColor(Color.TRANSPARENT);
        // 标签分割线边距
        tabs.setDividerPadding(DensityUtils.dpi2px(this, (int) 1.0f));
