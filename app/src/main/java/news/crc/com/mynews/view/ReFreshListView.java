...
/**
 * Created by LIYESHENG on 2017-4-22.
 */
...
public class ReFreshListView extends ListView {
    ...
    @ViewInject(R.id.txt_lastTime)
    private TextView lastupdate;

    private static int mCurrentState = STATE_PULL_REFRESH; //当前状态
    ...
    public ReFreshListView(Context context, AttributeSet attrs) {
        ...
        // 添加头布局文件
        headView = View.inflate(this.getContext(), R.layout.view_refresh_listview_head, null);
